...
app.post('/api/tokenize-url', async (req, res) => {
    ...
    try {
        ...
        // DIE REINE MATHEMATISCHE SCHÄTZUNG (Ohne Bibliothek):
        // Ein Token entspricht im KI-Schnitt ziemlich genau 4 Zeichen.
        ...
        res.json({
            ...
            tokenCount: estimatedTokenCount, // Exzellenter Näherungswert
            text: cleanText,
